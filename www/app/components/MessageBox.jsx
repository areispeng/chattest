...
import { kickOutUser } from '../actions/user.js'
...
class MessageBox extends React.Component{
    ...
    render(){
        ...
        const menuProps = {isPrivate, _id, Tid, ownerId, dir, timestamp, room}
        return (
...
// 菜单
function Menu(props){
    const { _id, isPrivate, ownerId, dir, Tid, timestamp, room } = props;
    let list = [];
    if(dir === 'right'){
        list.push(
            <li 
